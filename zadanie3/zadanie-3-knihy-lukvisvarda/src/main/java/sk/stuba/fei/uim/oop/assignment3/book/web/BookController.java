...
public class BookController {
    ...
    @DeleteMapping(value = "/{id}/amount", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public Amount removeAmount(@PathVariable("id") Long bookId, @RequestBody Amount body) throws NotFoundException, IllegalOperationException {
        return new Amount(this.service.removeAmount(bookId, body.getAmount()));
    }
